<?php
	 ...
	 *
	 * This allows for alternate goofy file path that would normally break
	 * cb_common.php incude paths.
	 *
	 ...
	 * @package cb_common
	 * @version $Id: cb_common_alt.php,v 1.1.1.1 2010/04/15 09:55:56 peimic.comprock Exp $
	 */
